            ...
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <div class="d-inline-flex text-white">
                        ...
                        <h6 class="page-title" style="color:#8486A0; font-size:0.875rem">User Team</h4>
                    </div>
                </div>
                            ...
                            <form class="form-horizontal" action="{{ url('mmladmin/user-team-info') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="add_city" class="col-sm-2 control-label">Team Name</label>
                                        <input id="add_city" type="text" name="name"  value="">
                                ...
                                <div class="form-group">
                                    <label for="add_city" class="col-sm-2 control-label">Designation</label>
                                        <input id="add_city" type="text" name="designation"  value="">
                                        <span class="text-danger">
                                            @error('designation')
                                            {{$message}}
                                            @enderror

                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <form class="form-horizontal" action="{{ url('mmladmin/label/view/update/'. $slider->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group">
                                    <label for="add_city" class="col-sm-2 control-label">Label 1</label>
                                        <input id="add_city" type="text" name="label1"  value="{{ $slider->label1 }}" >
                                </div>

                                <div class="form-group">
                                    <label for="add_city" class="col-sm-2 control-label">Label 2</label>
                                        <input id="add_city" type="text" name="label2"  value="{{ $slider->label2 }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="{{ asset('images/label/'.$slider->image) }}" width="100px;">
                                    
                                </div>

                                <div class="form-group">
                                    <input class="submit" type="submit" name="Submit" value="Update">
                                    <a href="{{ url('mmladmin/label/view') }}" class="submit-back me-1 mb-1">Back</a>
                                </div>

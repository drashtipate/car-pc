            ...
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <div class="d-inline-flex text-white">
                        ...
                        <h6 class="page-title" style="color:#8486A0; font-size:0.875rem">Manage Contactus</h4>
                    </div>
                </div>
                                        ...
                                        <tbody>
                                            @foreach ($data as $key => $item)
                                                <tr>
                                                    ...
                                                    <td class="name">{{ $item->emailId }}</td>
                                                    <td class="name">{{ $item->contactnumber }}</td>
                                                    <td class="name">{{ $item->message }}</td>
                                                    <td class="name">{{ $item->created_at }}</td>
                                                    <td><a href="{{ url('mmladmin/deletequery/'.$item->id) }}" onclick="return confirm('Are you sure to want to delete it?')"><i class="fas fa-trash-alt ml-3"></i></a></td>
                                                </tr>
                                            @endforeach   
                                        </tbody>
                                    </table>

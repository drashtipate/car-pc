              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="tbl">
                    ...
                    <button type="button" value="{{$querys->id}}" class="btn-block1" data-toggle="modal" data-target="#exampleModal">
                      Completed
                    </button>
...
<script>
  $(document).ready(function() {
    $(document).on('click', '.btn-block1', function() {
...
<!-- <script>
  $(document).ready(function() {
    $(document).on('click', '.btn-block1', function() {
      var stud_id = $(this).val();
      $.ajax({
        url: '/mmladmin/changes',
        type: 'post',
        data:'stud_id='+stud_id+'&_token={{csrf_token()}}',
        dataType: 'json',

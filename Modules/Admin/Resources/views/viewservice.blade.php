            ...
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <div class="d-inline-flex text-white">
                        ...
                        <h6 class="page-title" style="color:#8486A0; font-size:0.875rem">Manage Service</h4>
                    </div>
                </div>
                            ...
                            <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    ...
                                    <div class="modal-body">
                                        <form class="form-horizontal" action="{{ url('mmladmin/user-service-info') }}" method="post" enctype="multipart/form-data">
                                            @csrf
         
                                            <div class="form-group">
                                                <label for="add_city" class="col-sm-3 control-label">Service Type</label>
                                                    <input id="add_city" type="text" name="servicetype"  value="" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="add_state" class="col-sm-2 control-label">Choose File</label>
                                                <input type="file" name="serviceimage" id="add_country" class="border p-2  @error('image') is-invalid @enderror" required>
                                            </div>


                                            <div class="form-group">
                                                <label for="add_city" class="col-sm-2 control-label">Description</label>
                                                    <textarea rows="8" cols="50" id="add_about" type="text" name="description" required></textarea>
                                            </div>
                                    ...
                                    <table class="display table table-striped table-bordered table-hover dataTable " id="table1">
                                        <thead>
                                            <tr class="bg-color">
                                                ...
                                                <th class="tbl name">SERVICE TYPE</th>
                                        ...
                                        <tbody>
                                            @foreach ($data as $key => $item)
                                                <tr>
                                                    ...
                                                    <td class="name"> <img src="{{ asset('images/userserviceimg/'.$item->image) }}" width="70px;" height="70px;" alt="image"> </td>
                                                    <td class="tbl">{{ $item->description }}</td>
                                                    ...
                                                    <td style="text-align:center;">
                                                        ...
                                                        <a href="{{ url('mmladmin/service/edit/'.$item->id) }}">
                                                            <span class="badge bg-success"><i class="fa fa-edit"></i></span>
                                                        </a> 

                                                        <a href="{{ url('mmladmin/service/delete/'.$item->id) }}" onclick="return confirm('Are you sure to want to delete it?')">

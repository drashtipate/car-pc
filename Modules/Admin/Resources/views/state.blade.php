            ...
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <div class="d-inline-flex text-white">
                        ...
                        <h6 class="page-title" style="color:#8486A0; font-size:0.875rem">State</h4>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                        ...
                        <form class="form-horizontal" action="{{ url('mmladmin/states')}}" method="get">
                            @csrf
                            ...
                            <div class="form-group">
                                <label for="add_state" class="col-sm-2 control-label">Add State</label>
                                <input id="add_state" type="text" name="state">
                                <span class="text-danger">
                                    @error('state')
                                    {{$message}}
                                    @enderror

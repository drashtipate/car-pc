            ...
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <div class="d-inline-flex text-white">
                        ...
                        <h6 class="page-title" style="color:#8486A0; font-size:0.875rem">City</h4>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <form class="form-horizontal" action="{{ url('mmladmin/citys')}}" method="get">
                                 @csrf
                                <div class="form-group">
                                    <label for="country" class="col-sm-2 control-label">Country</label>
                                        <select id="country-dropdown" name="country">
                                        <!-- <select id="country-dropdown" name="country_id"> -->
                                ...
                                <div class="form-group">
                                    <label for="add_city" class="col-sm-2 control-label">Add City</label>

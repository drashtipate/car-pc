            ...
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <div class="d-inline-flex text-white">
                        ...
                        <h6 class="page-title" style="color:#8486A0; font-size:0.875rem">User Services</h4>
                    </div>
                </div>
                            ...
                            <form class="form-horizontal" action="{{ url('mmladmin/user-service-info') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="add_city" class="col-sm-2 control-label">Service Type</label>
                                        <input id="add_city" type="text" name="servicetype"  value="">
                                ...
                                <div class="form-group">
                                    <label for="add_city" class="col-sm-2 control-label">Description</label>
                                        <textarea rows="8" cols="50" id="add_about" type="text" name="description"></textarea>
                                        <span class="text-danger">
                                                @error('description')
                                                {{$message}}
                                                @enderror

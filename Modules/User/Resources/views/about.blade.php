...
<div class="container-fluid page-header">
    <h1 class="display-3 text-uppercase text-white mb-3" data-0-top="opacity:0;left:100px;" data-200-top="opacity:1;left:0px;">About</h1>
    <div class="d-inline-flex text-white" data-0-top="opacity:0;left:100px;" data-200-top="opacity:1;left:0px;">
        ...
        <h6 class="text-uppercase text-body m-0" style="font-weight:400;">About</h6>
    </div>
</div>
<!-- Page Header Start -->
...
<div class="container-fluid py-5">
    <div class="container pt-5 pb-3">
        <h1 class="display-4 text-uppercase text-center mb-5" data-center-center="opacity:1;top:0;" data-0-bottom="opacity:0;top:-300px;">Welcome To <span class="text-primary">Royal Cars</span></h1>
            ...
            <div class="col-lg-6 px-0" data-center-center="opacity:1;left:0;" data-0-bottom="opacity:0;left:-400px;">
                <div class="px-5 bg-secondary d-flex align-items-center justify-content-between" style="height: 350px;">
                    ...
                    <div class="text-right">
                        ...
                        <p class="mb-4" style="font-weight:400;">Lorem justo sit sit ipsum eos lorem kasd, kasd labore</p>

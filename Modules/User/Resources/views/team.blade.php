...
<div class="container-fluid page-header">
    <h1 class="display-3 text-uppercase text-white mb-3" data-0-top="opacity:0;right:100px;" data-200-top="opacity:1;right:0px;">The Team</h1>
    <div class="d-inline-flex text-white" data-0-top="opacity:0;right:100px;" data-200-top="opacity:1;right:0px;">
        ...
        <h6 class="text-uppercase text-body m-0" style="font-weight:400;">The Team</h6>
    </div>
</div>
<!-- Page Header Start -->
...
<div class="container-fluid py-5">
    <div class="container py-5">
        <h1 class="display-4 text-uppercase text-center mb-5" data-center-center="opacity:1;top:0;" data-0-bottom="opacity:0;top:-400px;">Meet Our Team</h1>
        <div class="owl-carousel team-carousel position-relative" style="padding: 0 30px;">
            ...
            <div class="team-item">
                ...
                <div class="position-relative py-4">
                    ...
                    <p class="m-0" style="font-weight:400;">{{$teamitem->designation}}</p>
